...
longest_name=df.loc[df["Name"].str.len().idxmax(),"Name"]
len_of_longest_name=len(longest_name)
df["longest_name"]=longest_name
df["len_of_longest_name"]=len_of_longest_name
print(df[["longest_name","len_of_longest_name"]])